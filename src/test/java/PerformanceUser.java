...
public class PerformanceUser {
    ...
    public void AddProductAndCheckout() throws InterruptedException {
        ...
        String BtnText = driver.findElement(By.id("remove-sauce-labs-bolt-t-shirt")).getText();
        ...
        boolean CartBadge  = driver.findElements(By.className("shopping_cart_badge")).size() == 1;
